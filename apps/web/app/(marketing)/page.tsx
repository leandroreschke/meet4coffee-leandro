      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="2.5"
            d="M4 7h12m0 0-3-3m3 3-3 3"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="2.5"
            d="M20 17H8m0 0 3 3m-3-3 3-3"
          />
        </svg>
      ),
    },
      ...
      <main className="bg-white px-6 pb-20 pt-2 md:px-10">
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <section className="flex flex-col justify-center py-24 md:py-32">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {featureItems.map((feature, i) => (
                ...
                >
                  <article
                    className={`h-full surface-card rounded-4xl p-8 ${feature.color}`}
                    style={{
                      boxShadow: `6px 6px 0px ${getShadowColor(feature.title)}`,
                    }}
                  >
          ...
          <section className="flex flex-col justify-center py-24 md:py-32">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {pricingItems.map((item, i) => (
                <FadeInSection key={item.tier} delay={i * 80}>
                  <article
                    className="flex flex-col rounded-4xl border-4 border-mocha-earth bg-white p-8 transition-transform hover:-translate-y-2"
                    style={{
                      boxShadow: `6px 6px 0px ${getShadowColor(item.tier)}`,
                    }}
                  >
                    ...
                    <ul className="mb-8 mt-8 grow space-y-4">
                      {item.features.map((feature, idx) => (
                        <li
                          key={idx}
                          className="flex items-start gap-3 text-lg font-bold leading-snug text-mocha-earth"
                        >
                          <svg
                    ...
                    <div
                      className={`mt-auto h-6 w-full rounded-full border-2 border-mocha-earth ${item.color}`}
                    />
                  </article>
                </FadeInSection>
              ))}
          ...
          <section className="flex flex-col justify-center py-24 md:py-32">
            <FadeInSection>
              <div
                className="w-full rounded-[3rem] border-4 border-mocha-earth bg-white p-10 text-center md:p-16"
                style={{
                  boxShadow: `6px 6px 0px ${getShadowColor("get-started")}`,
                }}
              >
                ...
                <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                  <Link
                    ...
                    className="rounded-full border-4 border-mocha-earth bg-mocha-earth px-8 py-4 text-lg font-black uppercase tracking-[0.16em] text-vanilla-cream! transition-all hover:translate-x-[6px] hover:translate-y-[6px] hover:bg-banana-split hover:text-mocha-earth! hover:shadow-none"
                    style={{
                      boxShadow: `6px 6px 0px ${getShadowColor("create-account")}`,
                    }}
                  >
                  ...
                  <Link
                    ...
                    transitionTypes={["nav-forward"]}
                    className="rounded-full border-4 border-mocha-earth bg-white px-8 py-4 text-lg font-black uppercase tracking-[0.16em] text-mocha-earth transition-all hover:translate-x-[6px] hover:translate-y-[6px] hover:bg-cotton-candy hover:shadow-none"
                    style={{
                      boxShadow: `6px 6px 0px ${getShadowColor("help-center")}`,
                    }}
                  >
          ...
          <footer
            className="rounded-[2.5rem] border-4 border-mocha-earth bg-white px-8 py-10"
            style={{ boxShadow: `6px 6px 0px ${getShadowColor("footer")}` }}
          >
            <div className="flex flex-wrap items-center justify-between gap-6 text-lg font-bold text-mocha-earth">
              ...
              <div className="flex items-center gap-6">
                <Link
                  ...
                  transitionTypes={["nav-forward"]}
                  className="transition-colors hover:text-strawberry-milk"
                >
                ...
                <Link
                  href={localizePath("/help", locale)}
                  transitionTypes={["nav-forward"]}
                  className="transition-colors hover:text-banana-split"
                >
